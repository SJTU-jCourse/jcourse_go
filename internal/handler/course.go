...
func convertCourseListFilter(request dto2.CourseListRequest) model.CourseListFilterForQuery {
...
func GetCourseListHandler(c *gin.Context) {
	request := dto2.CourseListRequest{
...
func GetBaseCourse(c *gin.Context) {
	var request dto2.BaseCourseDetailRequest
	if err := c.ShouldBindUri(&request); err != nil {
		c.JSON(http.StatusBadRequest, dto2.BaseResponse{Message: "参数错误"})
		return
	}
