...
func newReviewReactionPO(db *gorm.DB, opts ...gen.DOOption) reviewReactionPO {
	...
	_reviewReactionPO.reviewReactionPODo.UseModel(&po2.ReviewReactionPO{})
...
func (a reviewReactionPOBelongsToReview) Model(m *po2.ReviewReactionPO) *reviewReactionPOBelongsToReviewTx {
...
func (a reviewReactionPOBelongsToReviewTx) Find() (result *po2.ReviewPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewReactionPOBelongsToReviewTx) Append(values ...*po2.ReviewPO) (err error) {
...
func (a reviewReactionPOBelongsToReviewTx) Replace(values ...*po2.ReviewPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewReactionPOBelongsToReviewTx) Delete(values ...*po2.ReviewPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewReactionPOBelongsToUser) Model(m *po2.ReviewReactionPO) *reviewReactionPOBelongsToUserTx {
...
func (a reviewReactionPOBelongsToUserTx) Find() (result *po2.UserPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewReactionPOBelongsToUserTx) Append(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewReactionPOBelongsToUserTx) Replace(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewReactionPOBelongsToUserTx) Delete(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IReviewReactionPODo interface {
	...
	Create(values ...*po2.ReviewReactionPO) error
	CreateInBatches(values []*po2.ReviewReactionPO, batchSize int) error
	Save(values ...*po2.ReviewReactionPO) error
	First() (*po2.ReviewReactionPO, error)
	Take() (*po2.ReviewReactionPO, error)
	Last() (*po2.ReviewReactionPO, error)
	Find() ([]*po2.ReviewReactionPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewReactionPO, err error)
	FindInBatches(result *[]*po2.ReviewReactionPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.ReviewReactionPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.ReviewReactionPO, error)
	FirstOrCreate() (*po2.ReviewReactionPO, error)
	FindByPage(offset int, limit int) (result []*po2.ReviewReactionPO, count int64, err error)
...
func (r reviewReactionPODo) Create(values ...*po2.ReviewReactionPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewReactionPODo) CreateInBatches(values []*po2.ReviewReactionPO, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r reviewReactionPODo) Save(values ...*po2.ReviewReactionPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewReactionPODo) First() (*po2.ReviewReactionPO, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.ReviewReactionPO), nil
	}
}

func (r reviewReactionPODo) Take() (*po2.ReviewReactionPO, error) {
...
func (r reviewReactionPODo) Last() (*po2.ReviewReactionPO, error) {
...
func (r reviewReactionPODo) Find() ([]*po2.ReviewReactionPO, error) {
	result, err := r.DO.Find()
	return result.([]*po2.ReviewReactionPO), err
}

func (r reviewReactionPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewReactionPO, err error) {
	buf := make([]*po2.ReviewReactionPO, 0, batchSize)
...
func (r reviewReactionPODo) FindInBatches(result *[]*po2.ReviewReactionPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r reviewReactionPODo) FirstOrInit() (*po2.ReviewReactionPO, error) {
...
func (r reviewReactionPODo) FirstOrCreate() (*po2.ReviewReactionPO, error) {
...
func (r reviewReactionPODo) FindByPage(offset int, limit int) (result []*po2.ReviewReactionPO, count int64, err error) {
...
func (r reviewReactionPODo) Delete(models ...*po2.ReviewReactionPO) (result gen.ResultInfo, err error) {
