...
func newTrainingPlanCoursePO(db *gorm.DB, opts ...gen.DOOption) trainingPlanCoursePO {
	...
	_trainingPlanCoursePO.trainingPlanCoursePODo.UseModel(&po2.TrainingPlanCoursePO{})
...
func (a trainingPlanCoursePOBelongsToBaseCourse) Model(m *po2.TrainingPlanCoursePO) *trainingPlanCoursePOBelongsToBaseCourseTx {
...
func (a trainingPlanCoursePOBelongsToBaseCourseTx) Find() (result *po2.BaseCoursePO, err error) {
	return result, a.tx.Find(&result)
}

func (a trainingPlanCoursePOBelongsToBaseCourseTx) Append(values ...*po2.BaseCoursePO) (err error) {
...
func (a trainingPlanCoursePOBelongsToBaseCourseTx) Replace(values ...*po2.BaseCoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a trainingPlanCoursePOBelongsToBaseCourseTx) Delete(values ...*po2.BaseCoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a trainingPlanCoursePOBelongsToTrainingPlan) Model(m *po2.TrainingPlanCoursePO) *trainingPlanCoursePOBelongsToTrainingPlanTx {
...
func (a trainingPlanCoursePOBelongsToTrainingPlanTx) Find() (result *po2.TrainingPlanPO, err error) {
	return result, a.tx.Find(&result)
}

func (a trainingPlanCoursePOBelongsToTrainingPlanTx) Append(values ...*po2.TrainingPlanPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a trainingPlanCoursePOBelongsToTrainingPlanTx) Replace(values ...*po2.TrainingPlanPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a trainingPlanCoursePOBelongsToTrainingPlanTx) Delete(values ...*po2.TrainingPlanPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ITrainingPlanCoursePODo interface {
	...
	Create(values ...*po2.TrainingPlanCoursePO) error
	CreateInBatches(values []*po2.TrainingPlanCoursePO, batchSize int) error
	Save(values ...*po2.TrainingPlanCoursePO) error
	First() (*po2.TrainingPlanCoursePO, error)
	Take() (*po2.TrainingPlanCoursePO, error)
	Last() (*po2.TrainingPlanCoursePO, error)
	Find() ([]*po2.TrainingPlanCoursePO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.TrainingPlanCoursePO, err error)
	FindInBatches(result *[]*po2.TrainingPlanCoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.TrainingPlanCoursePO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.TrainingPlanCoursePO, error)
	FirstOrCreate() (*po2.TrainingPlanCoursePO, error)
	FindByPage(offset int, limit int) (result []*po2.TrainingPlanCoursePO, count int64, err error)
...
func (t trainingPlanCoursePODo) Create(values ...*po2.TrainingPlanCoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (t trainingPlanCoursePODo) CreateInBatches(values []*po2.TrainingPlanCoursePO, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t trainingPlanCoursePODo) Save(values ...*po2.TrainingPlanCoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (t trainingPlanCoursePODo) First() (*po2.TrainingPlanCoursePO, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.TrainingPlanCoursePO), nil
	}
}

func (t trainingPlanCoursePODo) Take() (*po2.TrainingPlanCoursePO, error) {
...
func (t trainingPlanCoursePODo) Last() (*po2.TrainingPlanCoursePO, error) {
...
func (t trainingPlanCoursePODo) Find() ([]*po2.TrainingPlanCoursePO, error) {
	result, err := t.DO.Find()
	return result.([]*po2.TrainingPlanCoursePO), err
}

func (t trainingPlanCoursePODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.TrainingPlanCoursePO, err error) {
	buf := make([]*po2.TrainingPlanCoursePO, 0, batchSize)
...
func (t trainingPlanCoursePODo) FindInBatches(result *[]*po2.TrainingPlanCoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t trainingPlanCoursePODo) FirstOrInit() (*po2.TrainingPlanCoursePO, error) {
...
func (t trainingPlanCoursePODo) FirstOrCreate() (*po2.TrainingPlanCoursePO, error) {
...
func (t trainingPlanCoursePODo) FindByPage(offset int, limit int) (result []*po2.TrainingPlanCoursePO, count int64, err error) {
...
func (t trainingPlanCoursePODo) Delete(models ...*po2.TrainingPlanCoursePO) (result gen.ResultInfo, err error) {
