...
func newCoursePO(db *gorm.DB, opts ...gen.DOOption) coursePO {
	...
	_coursePO.coursePODo.UseModel(&po2.CoursePO{})
...
func (a coursePOHasManyCategories) Model(m *po2.CoursePO) *coursePOHasManyCategoriesTx {
...
func (a coursePOHasManyCategoriesTx) Find() (result []*po2.CourseCategoryPO, err error) {
	return result, a.tx.Find(&result)
}

func (a coursePOHasManyCategoriesTx) Append(values ...*po2.CourseCategoryPO) (err error) {
...
func (a coursePOHasManyCategoriesTx) Replace(values ...*po2.CourseCategoryPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOHasManyCategoriesTx) Delete(values ...*po2.CourseCategoryPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOHasManyOfferedCourses) Model(m *po2.CoursePO) *coursePOHasManyOfferedCoursesTx {
...
func (a coursePOHasManyOfferedCoursesTx) Find() (result []*po2.OfferedCoursePO, err error) {
	return result, a.tx.Find(&result)
}

func (a coursePOHasManyOfferedCoursesTx) Append(values ...*po2.OfferedCoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOHasManyOfferedCoursesTx) Replace(values ...*po2.OfferedCoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOHasManyOfferedCoursesTx) Delete(values ...*po2.OfferedCoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOBelongsToMainTeacher) Model(m *po2.CoursePO) *coursePOBelongsToMainTeacherTx {
...
func (a coursePOBelongsToMainTeacherTx) Find() (result *po2.TeacherPO, err error) {
	return result, a.tx.Find(&result)
}

func (a coursePOBelongsToMainTeacherTx) Append(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOBelongsToMainTeacherTx) Replace(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a coursePOBelongsToMainTeacherTx) Delete(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type ICoursePODo interface {
	...
	Create(values ...*po2.CoursePO) error
	CreateInBatches(values []*po2.CoursePO, batchSize int) error
	Save(values ...*po2.CoursePO) error
	First() (*po2.CoursePO, error)
	Take() (*po2.CoursePO, error)
	Last() (*po2.CoursePO, error)
	Find() ([]*po2.CoursePO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.CoursePO, err error)
	FindInBatches(result *[]*po2.CoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.CoursePO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.CoursePO, error)
	FirstOrCreate() (*po2.CoursePO, error)
	FindByPage(offset int, limit int) (result []*po2.CoursePO, count int64, err error)
...
func (c coursePODo) Create(values ...*po2.CoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coursePODo) CreateInBatches(values []*po2.CoursePO, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c coursePODo) Save(values ...*po2.CoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (c coursePODo) First() (*po2.CoursePO, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.CoursePO), nil
	}
}

func (c coursePODo) Take() (*po2.CoursePO, error) {
...
func (c coursePODo) Last() (*po2.CoursePO, error) {
...
func (c coursePODo) Find() ([]*po2.CoursePO, error) {
	result, err := c.DO.Find()
	return result.([]*po2.CoursePO), err
}

func (c coursePODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.CoursePO, err error) {
	buf := make([]*po2.CoursePO, 0, batchSize)
...
func (c coursePODo) FindInBatches(result *[]*po2.CoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c coursePODo) FirstOrInit() (*po2.CoursePO, error) {
...
func (c coursePODo) FirstOrCreate() (*po2.CoursePO, error) {
...
func (c coursePODo) FindByPage(offset int, limit int) (result []*po2.CoursePO, count int64, err error) {
...
func (c coursePODo) Delete(models ...*po2.CoursePO) (result gen.ResultInfo, err error) {
