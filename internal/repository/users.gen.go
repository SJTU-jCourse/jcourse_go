...
func newUserPO(db *gorm.DB, opts ...gen.DOOption) userPO {
	...
	_userPO.userPODo.UseModel(&po2.UserPO{})
...
func (a userPOHasManyUserPointDetails) Model(m *po2.UserPO) *userPOHasManyUserPointDetailsTx {
...
func (a userPOHasManyUserPointDetailsTx) Find() (result []*po2.UserPointDetailPO, err error) {
	return result, a.tx.Find(&result)
}

func (a userPOHasManyUserPointDetailsTx) Append(values ...*po2.UserPointDetailPO) (err error) {
...
func (a userPOHasManyUserPointDetailsTx) Replace(values ...*po2.UserPointDetailPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userPOHasManyUserPointDetailsTx) Delete(values ...*po2.UserPointDetailPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IUserPODo interface {
	...
	Unscoped() IUserPODo
	Create(values ...*po2.UserPO) error
	CreateInBatches(values []*po2.UserPO, batchSize int) error
	Save(values ...*po2.UserPO) error
	First() (*po2.UserPO, error)
	Take() (*po2.UserPO, error)
	Last() (*po2.UserPO, error)
	Find() ([]*po2.UserPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.UserPO, err error)
	FindInBatches(result *[]*po2.UserPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.UserPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.UserPO, error)
	FirstOrCreate() (*po2.UserPO, error)
	FindByPage(offset int, limit int) (result []*po2.UserPO, count int64, err error)
...
func (u userPODo) Create(values ...*po2.UserPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userPODo) CreateInBatches(values []*po2.UserPO, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userPODo) Save(values ...*po2.UserPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userPODo) First() (*po2.UserPO, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.UserPO), nil
	}
}

func (u userPODo) Take() (*po2.UserPO, error) {
...
func (u userPODo) Last() (*po2.UserPO, error) {
...
func (u userPODo) Find() ([]*po2.UserPO, error) {
	result, err := u.DO.Find()
	return result.([]*po2.UserPO), err
}

func (u userPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.UserPO, err error) {
	buf := make([]*po2.UserPO, 0, batchSize)
...
func (u userPODo) FindInBatches(result *[]*po2.UserPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userPODo) FirstOrInit() (*po2.UserPO, error) {
...
func (u userPODo) FirstOrCreate() (*po2.UserPO, error) {
...
func (u userPODo) FindByPage(offset int, limit int) (result []*po2.UserPO, count int64, err error) {
...
func (u userPODo) Delete(models ...*po2.UserPO) (result gen.ResultInfo, err error) {
