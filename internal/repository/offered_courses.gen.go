...
func newOfferedCoursePO(db *gorm.DB, opts ...gen.DOOption) offeredCoursePO {
	...
	_offeredCoursePO.offeredCoursePODo.UseModel(&po2.OfferedCoursePO{})
...
func (a offeredCoursePOHasManyOfferedCourseTeacher) Model(m *po2.OfferedCoursePO) *offeredCoursePOHasManyOfferedCourseTeacherTx {
...
func (a offeredCoursePOHasManyOfferedCourseTeacherTx) Find() (result []*po2.OfferedCourseTeacherPO, err error) {
	return result, a.tx.Find(&result)
}

func (a offeredCoursePOHasManyOfferedCourseTeacherTx) Append(values ...*po2.OfferedCourseTeacherPO) (err error) {
...
func (a offeredCoursePOHasManyOfferedCourseTeacherTx) Replace(values ...*po2.OfferedCourseTeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOHasManyOfferedCourseTeacherTx) Delete(values ...*po2.OfferedCourseTeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToCourse) Model(m *po2.OfferedCoursePO) *offeredCoursePOBelongsToCourseTx {
...
func (a offeredCoursePOBelongsToCourseTx) Find() (result *po2.CoursePO, err error) {
	return result, a.tx.Find(&result)
}

func (a offeredCoursePOBelongsToCourseTx) Append(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToCourseTx) Replace(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToCourseTx) Delete(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToMainTeacher) Model(m *po2.OfferedCoursePO) *offeredCoursePOBelongsToMainTeacherTx {
...
func (a offeredCoursePOBelongsToMainTeacherTx) Find() (result *po2.TeacherPO, err error) {
	return result, a.tx.Find(&result)
}

func (a offeredCoursePOBelongsToMainTeacherTx) Append(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToMainTeacherTx) Replace(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a offeredCoursePOBelongsToMainTeacherTx) Delete(values ...*po2.TeacherPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IOfferedCoursePODo interface {
	...
	Create(values ...*po2.OfferedCoursePO) error
	CreateInBatches(values []*po2.OfferedCoursePO, batchSize int) error
	Save(values ...*po2.OfferedCoursePO) error
	First() (*po2.OfferedCoursePO, error)
	Take() (*po2.OfferedCoursePO, error)
	Last() (*po2.OfferedCoursePO, error)
	Find() ([]*po2.OfferedCoursePO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.OfferedCoursePO, err error)
	FindInBatches(result *[]*po2.OfferedCoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.OfferedCoursePO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.OfferedCoursePO, error)
	FirstOrCreate() (*po2.OfferedCoursePO, error)
	FindByPage(offset int, limit int) (result []*po2.OfferedCoursePO, count int64, err error)
...
func (o offeredCoursePODo) Create(values ...*po2.OfferedCoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (o offeredCoursePODo) CreateInBatches(values []*po2.OfferedCoursePO, batchSize int) error {
	return o.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (o offeredCoursePODo) Save(values ...*po2.OfferedCoursePO) error {
	if len(values) == 0 {
		return nil
	}
...
func (o offeredCoursePODo) First() (*po2.OfferedCoursePO, error) {
	if result, err := o.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.OfferedCoursePO), nil
	}
}

func (o offeredCoursePODo) Take() (*po2.OfferedCoursePO, error) {
...
func (o offeredCoursePODo) Last() (*po2.OfferedCoursePO, error) {
...
func (o offeredCoursePODo) Find() ([]*po2.OfferedCoursePO, error) {
	result, err := o.DO.Find()
	return result.([]*po2.OfferedCoursePO), err
}

func (o offeredCoursePODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.OfferedCoursePO, err error) {
	buf := make([]*po2.OfferedCoursePO, 0, batchSize)
...
func (o offeredCoursePODo) FindInBatches(result *[]*po2.OfferedCoursePO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (o offeredCoursePODo) FirstOrInit() (*po2.OfferedCoursePO, error) {
...
func (o offeredCoursePODo) FirstOrCreate() (*po2.OfferedCoursePO, error) {
...
func (o offeredCoursePODo) FindByPage(offset int, limit int) (result []*po2.OfferedCoursePO, count int64, err error) {
...
func (o offeredCoursePODo) Delete(models ...*po2.OfferedCoursePO) (result gen.ResultInfo, err error) {
