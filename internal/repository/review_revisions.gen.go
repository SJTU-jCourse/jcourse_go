...
func newReviewRevisionPO(db *gorm.DB, opts ...gen.DOOption) reviewRevisionPO {
	...
	_reviewRevisionPO.reviewRevisionPODo.UseModel(&po2.ReviewRevisionPO{})
...
func (a reviewRevisionPOBelongsToReview) Model(m *po2.ReviewRevisionPO) *reviewRevisionPOBelongsToReviewTx {
...
func (a reviewRevisionPOBelongsToReviewTx) Find() (result *po2.ReviewPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewRevisionPOBelongsToReviewTx) Append(values ...*po2.ReviewPO) (err error) {
...
func (a reviewRevisionPOBelongsToReviewTx) Replace(values ...*po2.ReviewPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewRevisionPOBelongsToReviewTx) Delete(values ...*po2.ReviewPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewRevisionPOBelongsToUser) Model(m *po2.ReviewRevisionPO) *reviewRevisionPOBelongsToUserTx {
...
func (a reviewRevisionPOBelongsToUserTx) Find() (result *po2.UserPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewRevisionPOBelongsToUserTx) Append(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewRevisionPOBelongsToUserTx) Replace(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewRevisionPOBelongsToUserTx) Delete(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IReviewRevisionPODo interface {
	...
	Create(values ...*po2.ReviewRevisionPO) error
	CreateInBatches(values []*po2.ReviewRevisionPO, batchSize int) error
	Save(values ...*po2.ReviewRevisionPO) error
	First() (*po2.ReviewRevisionPO, error)
	Take() (*po2.ReviewRevisionPO, error)
	Last() (*po2.ReviewRevisionPO, error)
	Find() ([]*po2.ReviewRevisionPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewRevisionPO, err error)
	FindInBatches(result *[]*po2.ReviewRevisionPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.ReviewRevisionPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.ReviewRevisionPO, error)
	FirstOrCreate() (*po2.ReviewRevisionPO, error)
	FindByPage(offset int, limit int) (result []*po2.ReviewRevisionPO, count int64, err error)
...
func (r reviewRevisionPODo) Create(values ...*po2.ReviewRevisionPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewRevisionPODo) CreateInBatches(values []*po2.ReviewRevisionPO, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r reviewRevisionPODo) Save(values ...*po2.ReviewRevisionPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewRevisionPODo) First() (*po2.ReviewRevisionPO, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.ReviewRevisionPO), nil
	}
}

func (r reviewRevisionPODo) Take() (*po2.ReviewRevisionPO, error) {
...
func (r reviewRevisionPODo) Last() (*po2.ReviewRevisionPO, error) {
...
func (r reviewRevisionPODo) Find() ([]*po2.ReviewRevisionPO, error) {
	result, err := r.DO.Find()
	return result.([]*po2.ReviewRevisionPO), err
}

func (r reviewRevisionPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewRevisionPO, err error) {
	buf := make([]*po2.ReviewRevisionPO, 0, batchSize)
...
func (r reviewRevisionPODo) FindInBatches(result *[]*po2.ReviewRevisionPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r reviewRevisionPODo) FirstOrInit() (*po2.ReviewRevisionPO, error) {
...
func (r reviewRevisionPODo) FirstOrCreate() (*po2.ReviewRevisionPO, error) {
...
func (r reviewRevisionPODo) FindByPage(offset int, limit int) (result []*po2.ReviewRevisionPO, count int64, err error) {
...
func (r reviewRevisionPODo) Delete(models ...*po2.ReviewRevisionPO) (result gen.ResultInfo, err error) {
