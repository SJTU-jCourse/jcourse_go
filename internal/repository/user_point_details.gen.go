...
func newUserPointDetailPO(db *gorm.DB, opts ...gen.DOOption) userPointDetailPO {
	...
	_userPointDetailPO.userPointDetailPODo.UseModel(&po2.UserPointDetailPO{})
...
func (a userPointDetailPOBelongsToUser) Model(m *po2.UserPointDetailPO) *userPointDetailPOBelongsToUserTx {
...
func (a userPointDetailPOBelongsToUserTx) Find() (result *po2.UserPO, err error) {
	return result, a.tx.Find(&result)
}

func (a userPointDetailPOBelongsToUserTx) Append(values ...*po2.UserPO) (err error) {
...
func (a userPointDetailPOBelongsToUserTx) Replace(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userPointDetailPOBelongsToUserTx) Delete(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IUserPointDetailPODo interface {
	...
	Create(values ...*po2.UserPointDetailPO) error
	CreateInBatches(values []*po2.UserPointDetailPO, batchSize int) error
	Save(values ...*po2.UserPointDetailPO) error
	First() (*po2.UserPointDetailPO, error)
	Take() (*po2.UserPointDetailPO, error)
	Last() (*po2.UserPointDetailPO, error)
	Find() ([]*po2.UserPointDetailPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.UserPointDetailPO, err error)
	FindInBatches(result *[]*po2.UserPointDetailPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.UserPointDetailPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.UserPointDetailPO, error)
	FirstOrCreate() (*po2.UserPointDetailPO, error)
	FindByPage(offset int, limit int) (result []*po2.UserPointDetailPO, count int64, err error)
...
func (u userPointDetailPODo) Create(values ...*po2.UserPointDetailPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userPointDetailPODo) CreateInBatches(values []*po2.UserPointDetailPO, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userPointDetailPODo) Save(values ...*po2.UserPointDetailPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userPointDetailPODo) First() (*po2.UserPointDetailPO, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.UserPointDetailPO), nil
	}
}

func (u userPointDetailPODo) Take() (*po2.UserPointDetailPO, error) {
...
func (u userPointDetailPODo) Last() (*po2.UserPointDetailPO, error) {
...
func (u userPointDetailPODo) Find() ([]*po2.UserPointDetailPO, error) {
	result, err := u.DO.Find()
	return result.([]*po2.UserPointDetailPO), err
}

func (u userPointDetailPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.UserPointDetailPO, err error) {
	buf := make([]*po2.UserPointDetailPO, 0, batchSize)
...
func (u userPointDetailPODo) FindInBatches(result *[]*po2.UserPointDetailPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userPointDetailPODo) FirstOrInit() (*po2.UserPointDetailPO, error) {
...
func (u userPointDetailPODo) FirstOrCreate() (*po2.UserPointDetailPO, error) {
...
func (u userPointDetailPODo) FindByPage(offset int, limit int) (result []*po2.UserPointDetailPO, count int64, err error) {
...
func (u userPointDetailPODo) Delete(models ...*po2.UserPointDetailPO) (result gen.ResultInfo, err error) {
