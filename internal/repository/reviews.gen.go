...
func newReviewPO(db *gorm.DB, opts ...gen.DOOption) reviewPO {
	...
	_reviewPO.reviewPODo.UseModel(&po2.ReviewPO{})
...
func (a reviewPOHasManyRevisions) Model(m *po2.ReviewPO) *reviewPOHasManyRevisionsTx {
...
func (a reviewPOHasManyRevisionsTx) Find() (result []*po2.ReviewRevisionPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewPOHasManyRevisionsTx) Append(values ...*po2.ReviewRevisionPO) (err error) {
...
func (a reviewPOHasManyRevisionsTx) Replace(values ...*po2.ReviewRevisionPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOHasManyRevisionsTx) Delete(values ...*po2.ReviewRevisionPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOHasManyReaction) Model(m *po2.ReviewPO) *reviewPOHasManyReactionTx {
...
func (a reviewPOHasManyReactionTx) Find() (result []*po2.ReviewReactionPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewPOHasManyReactionTx) Append(values ...*po2.ReviewReactionPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOHasManyReactionTx) Replace(values ...*po2.ReviewReactionPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOHasManyReactionTx) Delete(values ...*po2.ReviewReactionPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToCourse) Model(m *po2.ReviewPO) *reviewPOBelongsToCourseTx {
...
func (a reviewPOBelongsToCourseTx) Find() (result *po2.CoursePO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewPOBelongsToCourseTx) Append(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToCourseTx) Replace(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToCourseTx) Delete(values ...*po2.CoursePO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToUser) Model(m *po2.ReviewPO) *reviewPOBelongsToUserTx {
	return &reviewPOBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

type reviewPOBelongsToUserTx struct{ tx *gorm.Association }

func (a reviewPOBelongsToUserTx) Find() (result *po2.UserPO, err error) {
	return result, a.tx.Find(&result)
}

func (a reviewPOBelongsToUserTx) Append(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToUserTx) Replace(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a reviewPOBelongsToUserTx) Delete(values ...*po2.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IReviewPODo interface {
	...
	Create(values ...*po2.ReviewPO) error
	CreateInBatches(values []*po2.ReviewPO, batchSize int) error
	Save(values ...*po2.ReviewPO) error
	First() (*po2.ReviewPO, error)
	Take() (*po2.ReviewPO, error)
	Last() (*po2.ReviewPO, error)
	Find() ([]*po2.ReviewPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewPO, err error)
	FindInBatches(result *[]*po2.ReviewPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po2.ReviewPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po2.ReviewPO, error)
	FirstOrCreate() (*po2.ReviewPO, error)
	FindByPage(offset int, limit int) (result []*po2.ReviewPO, count int64, err error)
...
func (r reviewPODo) Create(values ...*po2.ReviewPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewPODo) CreateInBatches(values []*po2.ReviewPO, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r reviewPODo) Save(values ...*po2.ReviewPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r reviewPODo) First() (*po2.ReviewPO, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po2.ReviewPO), nil
	}
}

func (r reviewPODo) Take() (*po2.ReviewPO, error) {
...
func (r reviewPODo) Last() (*po2.ReviewPO, error) {
...
func (r reviewPODo) Find() ([]*po2.ReviewPO, error) {
	result, err := r.DO.Find()
	return result.([]*po2.ReviewPO), err
}

func (r reviewPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po2.ReviewPO, err error) {
	buf := make([]*po2.ReviewPO, 0, batchSize)
...
func (r reviewPODo) FindInBatches(result *[]*po2.ReviewPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r reviewPODo) FirstOrInit() (*po2.ReviewPO, error) {
...
func (r reviewPODo) FirstOrCreate() (*po2.ReviewPO, error) {
...
func (r reviewPODo) FindByPage(offset int, limit int) (result []*po2.ReviewPO, count int64, err error) {
...
func (r reviewPODo) Delete(models ...*po2.ReviewPO) (result gen.ResultInfo, err error) {
