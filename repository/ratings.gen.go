...
func newRatingPO(db *gorm.DB, opts ...gen.DOOption) ratingPO {
	...
	_ratingPO.ratingPODo.UseModel(&po.RatingPO{})
...
func (a ratingPOBelongsToUser) Model(m *po.RatingPO) *ratingPOBelongsToUserTx {
	return &ratingPOBelongsToUserTx{a.db.Model(m).Association(a.Name())}
}

type ratingPOBelongsToUserTx struct{ tx *gorm.Association }

func (a ratingPOBelongsToUserTx) Find() (result *po.UserPO, err error) {
	return result, a.tx.Find(&result)
}

func (a ratingPOBelongsToUserTx) Append(values ...*po.UserPO) (err error) {
...
func (a ratingPOBelongsToUserTx) Replace(values ...*po.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a ratingPOBelongsToUserTx) Delete(values ...*po.UserPO) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type IRatingPODo interface {
	...
	Create(values ...*po.RatingPO) error
	CreateInBatches(values []*po.RatingPO, batchSize int) error
	Save(values ...*po.RatingPO) error
	First() (*po.RatingPO, error)
	Take() (*po.RatingPO, error)
	Last() (*po.RatingPO, error)
	Find() ([]*po.RatingPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.RatingPO, err error)
	FindInBatches(result *[]*po.RatingPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.RatingPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.RatingPO, error)
	FirstOrCreate() (*po.RatingPO, error)
	FindByPage(offset int, limit int) (result []*po.RatingPO, count int64, err error)
...
func (r ratingPODo) Create(values ...*po.RatingPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r ratingPODo) CreateInBatches(values []*po.RatingPO, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r ratingPODo) Save(values ...*po.RatingPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (r ratingPODo) First() (*po.RatingPO, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.RatingPO), nil
	}
}

func (r ratingPODo) Take() (*po.RatingPO, error) {
...
func (r ratingPODo) Last() (*po.RatingPO, error) {
...
func (r ratingPODo) Find() ([]*po.RatingPO, error) {
	result, err := r.DO.Find()
	return result.([]*po.RatingPO), err
}

func (r ratingPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.RatingPO, err error) {
	buf := make([]*po.RatingPO, 0, batchSize)
...
func (r ratingPODo) FindInBatches(result *[]*po.RatingPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r ratingPODo) FirstOrInit() (*po.RatingPO, error) {
...
func (r ratingPODo) FirstOrCreate() (*po.RatingPO, error) {
...
func (r ratingPODo) FindByPage(offset int, limit int) (result []*po.RatingPO, count int64, err error) {
...
func (r ratingPODo) Delete(models ...*po.RatingPO) (result gen.ResultInfo, err error) {
