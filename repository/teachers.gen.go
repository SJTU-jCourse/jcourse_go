...
func newTeacherPO(db *gorm.DB, opts ...gen.DOOption) teacherPO {
	...
	_teacherPO.teacherPODo.UseModel(&po.TeacherPO{})
...
type ITeacherPODo interface {
	...
	Create(values ...*po.TeacherPO) error
	CreateInBatches(values []*po.TeacherPO, batchSize int) error
	Save(values ...*po.TeacherPO) error
	First() (*po.TeacherPO, error)
	Take() (*po.TeacherPO, error)
	Last() (*po.TeacherPO, error)
	Find() ([]*po.TeacherPO, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.TeacherPO, err error)
	FindInBatches(result *[]*po.TeacherPO, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.TeacherPO) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.TeacherPO, error)
	FirstOrCreate() (*po.TeacherPO, error)
	FindByPage(offset int, limit int) (result []*po.TeacherPO, count int64, err error)
...
func (t teacherPODo) Create(values ...*po.TeacherPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (t teacherPODo) CreateInBatches(values []*po.TeacherPO, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t teacherPODo) Save(values ...*po.TeacherPO) error {
	if len(values) == 0 {
		return nil
	}
...
func (t teacherPODo) First() (*po.TeacherPO, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.TeacherPO), nil
	}
}

func (t teacherPODo) Take() (*po.TeacherPO, error) {
...
func (t teacherPODo) Last() (*po.TeacherPO, error) {
...
func (t teacherPODo) Find() ([]*po.TeacherPO, error) {
	result, err := t.DO.Find()
	return result.([]*po.TeacherPO), err
}

func (t teacherPODo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.TeacherPO, err error) {
	buf := make([]*po.TeacherPO, 0, batchSize)
...
func (t teacherPODo) FindInBatches(result *[]*po.TeacherPO, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t teacherPODo) FirstOrInit() (*po.TeacherPO, error) {
...
func (t teacherPODo) FirstOrCreate() (*po.TeacherPO, error) {
...
func (t teacherPODo) FindByPage(offset int, limit int) (result []*po.TeacherPO, count int64, err error) {
...
func (t teacherPODo) Delete(models ...*po.TeacherPO) (result gen.ResultInfo, err error) {
